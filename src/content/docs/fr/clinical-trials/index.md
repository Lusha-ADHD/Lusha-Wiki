---
title: Informations sur l'essai clinique Lusha
description: Explication parentale de l'étude de faisabilité LUSHA NCT07204873 et cadre de prudence pour les informations cliniques.
---

Cette page résume en langage simple les informations publiques disponibles sur l'étude LUSHA référencée sur ClinicalTrials.gov. Elle doit être maintenue avec prudence, car les informations de santé peuvent être sensibles et évoluer.

> Ce wiki est uniquement informatif et ne remplace pas l'avis d'un professionnel de santé qualifié ou d'un coordinateur d'essai officiel.

## Source officielle

La fiche publique de référence est : [NCT07204873 - Evaluation of the LUSHA Digital Application for Children With ADHD - Feasibility Study](https://clinicaltrials.gov/study/NCT07204873?term=lusha&viewType=Card&rank=1).

Les informations ci-dessous sont vulgarisées à partir du PDF ClinicalTrials.gov fourni, consulté le 2 mai 2026. Dans ce PDF, la fiche indique une dernière mise à jour publiée le 2 octobre 2025 et une dernière vérification en septembre 2025.
...
Les objectifs secondaires regardent aussi plusieurs dimensions importantes pour les familles :
...
D'après la fiche publique, l'étude concerne des enfants âgés de 7 à 12 ans, déjà diagnostiqués avec un TDAH, suivis dans un centre participant et dont le traitement ne nécessite pas de changement immédiat. La famille doit disposer d'un smartphone compatible avec l'application.
...
Le PDF ClinicalTrials.gov indique deux sites en France :
