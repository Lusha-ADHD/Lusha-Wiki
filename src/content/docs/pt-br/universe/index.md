...
A história começa em um sótão cheio de objetos de aventureiros. No fundo da sala, um baú estranho treme e emite uma luz. Quando a criança se aproxima, o baú se abre de repente e a puxa para outro mundo.
...
O acampamento é o primeiro lugar estável do jogador na selva. Ele serve como base para descansar, guardar objetos, fabricar novos elementos e preparar as próximas explorações.

Ao longo da aventura, o jogador pode melhorar ou personalizar diferentes elementos do acampamento, como a fogueira, a bancada de trabalho, o baú, a casa, a horta ou o diário da exploradora.

O acampamento também é um lugar de encontro. O jogador pode reencontrar vários companheiros ali, especialmente Tigum e Igor, antes de voltar a explorar a selva.

A manutenção continua simples, mas dá ao jogador referências regulares: retirar ervas daninhas, cuidar do fogo, regar a horta ou melhorar alguns elementos. O acampamento faz eco a uma ideia central de Lusha: pequenas ações repetidas podem tornar um ambiente mais acolhedor e mais fácil de usar.
...
Jane é uma exploradora que chegou à selva vários anos antes do jogador. Ela parece ter vivido uma experiência parecida: ser levada para Lusha, precisar sobreviver, construir um acampamento e procurar uma forma de voltar para casa.
...
Algumas estátuas antigas parecem impregnadas pela magia de Lusha. Elas podem falar, reagir ao jogador e parecem proteger estruturas ligadas aos Luyas.

## A selva

A selva de Lusha é vasta e variada. O jogador descobre plantas exóticas, recursos, ruínas antigas e lugares que convidam a voltar várias vezes para explorar. A aventura não se limita ao chão da selva: ela também pode levar às alturas, como falésias ou copas das árvores, e às profundezas, especialmente em cavernas.
...
Lusha parece ser um mundo paralelo ao nosso. Portais podem conectar os dois universos, às vezes de maneira descontrolada, especialmente durante fenômenos fortes como tempestades. O baú do sótão e as estelas da selva parecem ligados a essa lógica de passagem entre mundos.
